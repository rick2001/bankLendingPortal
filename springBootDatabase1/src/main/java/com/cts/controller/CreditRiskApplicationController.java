...
public class CreditRiskApplicationController {
	...
	public ResponseEntity<List<CreditRisk>> getDetails() {
		List<CreditRisk> res=this.creditRiskService.getAllDetails();
		return new ResponseEntity<>(res,HttpStatus.OK);
	}
	
	@PostMapping("creditrisk/add")
	public ResponseEntity<String> details(@RequestBody CreditRisk val){
//		String crid="CR"+val.getLoanApplication();
//		val.setCrId(crid);
		String res=this.creditRiskService.addDetails(val);
		if(res.equals("yes")) {
